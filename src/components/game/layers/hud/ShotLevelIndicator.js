...
import { MAX_SHOT_LEVEL } from '../../weapons/ShotEmitter'

const { resources } = PIXI.loader

const spacing   = 3
const itemWidth = (260 - (MAX_SHOT_LEVEL - 1) * spacing) / MAX_SHOT_LEVEL

export default class ShotLevelIndicator extends PIXI.Container {
    constructor() {
        super()
        ...
        _.range(MAX_SHOT_LEVEL).forEach(i => {
